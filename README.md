...
Предусловия: <br>
  ...
  - создать bucket в AmazonS3 с именем reports
...
В результате работы программы python в AmazonS3 в bucket с именем reports должен быть создан файл report-pandas-simple.csv который хранит результат вычислений согласно условию ТЗ.
